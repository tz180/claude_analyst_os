...
-- Portfolio RLS Policies - Allow all access for development
CREATE POLICY "Allow all portfolios" ON portfolios
    FOR ALL USING (true);

-- Portfolio Positions RLS Policies - Allow all access for development
CREATE POLICY "Allow all portfolio positions" ON portfolio_positions
    FOR ALL USING (true);

-- Portfolio Transactions RLS Policies - Allow all access for development
CREATE POLICY "Allow all portfolio transactions" ON portfolio_transactions
    FOR ALL USING (true);
